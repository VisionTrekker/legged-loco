...
# blind
gym.register(
    id="LeggedLoco-Isaac-Velocity-Flat-Recover-Go2W-v0",
...
gym.register(
    id="LeggedLoco-Isaac-Velocity-Flat-Recover-Play-Go2W-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# blind
gym.register(
    id="LeggedLoco-Isaac-Velocity-Rough-Recover-Go2W-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="LeggedLoco-Isaac-Velocity-Rough-Recover-Play-Go2W-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
