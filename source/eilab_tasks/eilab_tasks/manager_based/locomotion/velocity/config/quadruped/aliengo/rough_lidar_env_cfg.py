...
##
# use local assets
from eilab_tasks.assets.robots.unitree import UNITREE_ALIENGO_CFG
from eilab_tasks.assets.terrains import ROUGH_TERRAINS_CFG


@configclass
class AlienGoRoughLidarEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "AlienGoRoughLidarEnvCfg":
...
@configclass
class AlienGoRoughLidarPlayEnvCfg(AlienGoRoughLidarEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
