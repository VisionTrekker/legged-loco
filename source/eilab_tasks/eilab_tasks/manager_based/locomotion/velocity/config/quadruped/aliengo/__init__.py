...
# blind
gym.register(
    id="EiLab-Isaac-Velocity-Flat-AlienGo-v0",
...
gym.register(
    id="EiLab-Isaac-Velocity-Flat-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# with mid-360
gym.register(
    id="EiLab-Isaac-Velocity-Flat-Lidar-AlienGo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="EiLab-Isaac-Velocity-Flat-Lidar-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# blind
gym.register(
    id="EiLab-Isaac-Velocity-Rough-AlienGo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="EiLab-Isaac-Velocity-Rough-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# with mid-360
gym.register(
    id="EiLab-Isaac-Velocity-Rough-Lidar-AlienGo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="EiLab-Isaac-Velocity-Rough-Lidar-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# blind
gym.register(
    id="EiLab-Isaac-Velocity-Flat-Recover-AlienGo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="EiLab-Isaac-Velocity-Flat-Recover-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
# blind
gym.register(
    id="EiLab-Isaac-Velocity-Rough-Recover-AlienGo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="EiLab-Isaac-Velocity-Rough-Recover-AlienGo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
