...
# Pre-defined configs
##
from leggedloco_tasks.assets.terrains import ROUGH_BLIND_TERRAINS_CFG, ROUGH_TERRAINS_CFG
...
class VelocitySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        physics_material=sim_utils.RigidBodyMaterialCfg(
            friction_combine_mode="multiply",  # 发生碰撞时的摩擦系数的结合方式，默认为average
            restitution_combine_mode="multiply",  # 发生碰撞时的恢复系数的结合方式，默认为average
            static_friction=1.0,
